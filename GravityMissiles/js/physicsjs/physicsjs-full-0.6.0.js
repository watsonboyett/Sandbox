    ...
    Vector.prototype.angle = function( v ){
        ...
        if ( this.equals( Vector.zero ) ){
            ...
            if ( v && !v.equals( Vector.zero ) ){
               // TODO: push back into class module
                //ang = atan2( this._[1] * v._[0] - this._[0] * v._[1], this._[0] * v._[0] + this._[1] * v._[1]);
               ang = atan2( this._[1] - v._[1], this._[0] - v._[0]);
            } else {
...
Physics.behavior('edge-collision-detection', function( parent ){
    ...
    */
   var checkGeneral = function checkGeneral( body, bounds, dummy, sides ){
// TODO: push changes back into class module
       var overlap
          ,checkSide = true
          ,aabb = body.aabb()
          ,scratch = Physics.scratchpad()
       ...
       // right
       checkSide = sides.right; 
       overlap = (aabb.x + aabb.hw) - bounds.max.x;

       if ( checkSide && overlap >= 0 ){
    ...
    * Check if a body collides with the boundary
    */
   var checkEdgeCollide = function checkEdgeCollide( body, bounds, dummy, sides ){

       return checkGeneral( body, bounds, dummy, sides );
   };
       ...
       checkAll: function( data ){
           ...
           for ( var i = 0, l = bodies.length; i < l; i++ ){
               ...
               if ( body.treatment === 'dynamic' ){
                   ...
                   ret = checkEdgeCollide( body, bounds, dummy, sides );
